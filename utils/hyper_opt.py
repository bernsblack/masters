...
def hyperparam_selection(func, hyper_parameters_domain, n_iter=5, goal='minimize'):
    ...
    for x in X_samples:
        y_samples.append(
            func(*x))  # make sure your definition of train_network linesup with the X_samples variable order
    ...
    for i in range(n_iter):
        ...
        y_mean, y_std = gaussian_process(x_samples=X_samples_normed, y_samples=y_samples,
