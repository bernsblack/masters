...
class GenericDataLoaders:
    def __init__(self, file_path=None, conf=BaseConf()):
        ...
        if file_path:
            ...
            print(f"Inverted Class Weights: {inv_weights(targets)}")
        ...
        training_set = GenericDataset(in_features[trn_index[0]:trn_index[1]], targets[trn_index[0]:trn_index[1]])
        validation_set = GenericDataset(in_features[val_index[0]:val_index[1]], targets[val_index[0]:val_index[1]])
        testing_set = GenericDataset(in_features[tst_index[0]:tst_index[1]], targets[tst_index[0]:tst_index[1]])
